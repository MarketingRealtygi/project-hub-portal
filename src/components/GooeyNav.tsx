...
const GooeyNav = ({
  ...
  const playEffect = (element: HTMLLIElement, withParticles = true) => {
  ...
  useEffect(() => {
    ...
    if (activeLi) {
      const shouldAnimate = previousActiveIndexRef.current !== activeIndex;
      playEffect(activeLi, shouldAnimate);
